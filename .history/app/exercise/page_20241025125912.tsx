    ...
    <div className="">
      ...
      >
        ...
        <div className="flex gap-3">
          <Button className="group relativ bg-transparent inline-flex items-center overflow-hidden rounded-full border-2 border-fuchsia-800 px-12 py-3 text-lg font-medium text-fuchsia-800 hover:bg-gray-50 hover:text-white">
