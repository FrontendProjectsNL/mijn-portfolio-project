  ...
  return (
    <div className="flex flex-col px-24 mt-28 w-full h-screen font-bold space-y-12">
      ...
      <motion.div className=" space-y-12">
        ...
        >
          <Card className="col-span-2 col-start-3 h-52 w-48 flex flex-col items-center justify-center">
            <Image
          ...
          <Card className="col-span-2 col-start-7  h-52 w-48 flex flex-col items-center justify-center">
            <Image
