    ...
    <div className="">
      ...
      >
        ...
        <div className="flex gap-3">
          <button className="group relative inline-flex items-center overflow-hidden rounded-full border-2 border-black px-12 py-2 text-lg font-medium text-black hover:bg-gray-50 hover:text-white">
