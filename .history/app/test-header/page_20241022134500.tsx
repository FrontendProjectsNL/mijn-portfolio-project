  ...
  return (
    <div>
      ...
      <div
        ...
        onClick={() => setExpanded(!expanded)}
      >
        <div className="relative h-[7px] w-14">
          <span className="absolute h-[7px] w-14 bg-black -translate-y-4 rounded group-aria-expanded:-rotate-45 group-aria-expanded:-translate-y-1/2"></span>
          <span className="absolute h-[7px] w-14 bg-black rounded group-aria-expanded:rotate-45"></span>
          <span className="absolute h-[7px] w-10 right-0 bg-black translate-y-4 rounded group-aria-expanded:-rotate-45 before:absolute before:right-0 before:h-full before:w-[60%] before:rounded-full before:bg-[var(--color)] before:transition-[right]  before:duration-[calc(var(--duration)*2/3)] group-aria-expanded:-translate-y-1/2 group-aria-expanded:-rotate-45"></span>
        </div>
      </div>
    </div>
  );
