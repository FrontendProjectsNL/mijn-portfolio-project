    ...
    <div>
      ...
      >
        <div className="relative h-[7px] w-14">
          <span className="absolute h-[7px] w-14 bg-black -translate-y-4 rounded group-aria-expanded:-rotate-45 group-aria-expanded:translate-y-1"></span>
          <span className="absolute h-[7px] w-14 bg-black rounded group-aria-expanded:rotate-45 group-aria-expanded:translate-y-1 "></span>
          <span className="absolute h-[7px] w-10 right-0 bg-black translate-y-4 rounded group-aria-expanded:-rotate-45 group-aria-expanded:-translate-x-7 group-aria-expanded:w-6 group-aria-expanded:opacity-0 transition-transform duration-300"></span>
        </div>
      </div>
    </div>
  );
