    ...
    <div className="mt-10 ml-40">
      ...
      >
        ...
        <div className="h-10 w-10 bg-transparent cursor-pointer">
          ...
          {/* Middle line */}
          <span className="absolute left-1/2 top-1/2 h-[var(--thickness)] w-[var(--width)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-red-500 transition-transform duration-[calc(var(--duration)*2/3)] group-aria-expanded:rotate-45 group-aria-expanded:delay-[calc(var(--duration)*1/3)]"></span>
