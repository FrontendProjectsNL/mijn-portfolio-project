    ...
    <div>
      ...
      >
        <div className="relative h-[7px] w-14">
          ...
          <span className="absolute h-[7px] w-10 right-0 bg-black translate-y-4 rounded group-aria-expanded:-rotate-45 group-aria-expanded:-translate-x-5 group-aria-expanded:w-7"></span>
        </div>
      </div>
    </div>
  );
