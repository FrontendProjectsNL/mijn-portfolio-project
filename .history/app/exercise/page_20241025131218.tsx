    ...
    <div className="">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <Link
            href={'/'}
            className="flex items-center gap-2 text-lg font-medium font-roboto mr-4"
          >
            <User className="w-8 h-8 hover:scale-150" />
            <span className="relative transform duration-700 group-hover:-translate-x-3">
              Sing In
            </span>
          </Link>

          <button className="font-roboto group relative inline-flex items-center overflow-hidden rounded-full border-2 border-black px-12 py-2 text-lg font-medium text-black hover:bg-gray-50 hover:text-white">
