  ...
  return (
    <div className="flex flex-col px-24 mt-28 w-full h-screen font-bold space-y-12">
      ...
      <div className="grid grid-cols-5 gap-12">
        ...
        <div className="col-span-3 col-start-2 flex justify-center pl-10">
          <Card className="h-52 w-48 flex flex-col items-center justify-center">
            <Image
              src="/tech-icons/zAvyayM9_400x400.jpg"
              width={150}
              height={150}
              alt="Kinde"
            />
            <p className="font-medium text-sm">Kinde Authentication</p>
          </Card>
        </div>

        <Card className="col-span-1 col-start-4 h-52 w-48 flex flex-col items-center justify-center">
          <Image
