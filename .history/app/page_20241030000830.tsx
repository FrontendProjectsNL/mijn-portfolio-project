      ...
      <div className="h-screen">
        <section className="flex justify-between items-center w-[90%] h-[90%] mx-auto bg-[#DFEFF0] rounded-3xl md:px-16 ">
          ...
          <div className="flex flex-col">
            ...
            <p className="py-4 px-6 sm:py-6 sm:px-8 md:py-8 md:px-10 lg:py-10 lg:px-12 xl:py-12 xl:px-14 leading-relaxed sm:leading-loose md:leading-normal lg:leading-relaxed xl:leading-tight text-base sm:text-lg md:text-xl lg:text-xl xl:text-2xl">
            ...
            <button className="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-6 rounded-lg animate-bounce">
              Team Collaboration
            </button>
          </div>
        </section>
