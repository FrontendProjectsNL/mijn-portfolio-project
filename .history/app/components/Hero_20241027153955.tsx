        ...
        <div className="w-[50%] h-screen bg-blue-300 flex flex-col justify-center items-center">
          ...
          <div>
            <button className="rounded-full group bg-black relative m-1 cursor-pointer overflow-hidden px-12 py-4 font-mono font-semibold">
              <span className="ease absolute top-1/2 h-0 w-64 origin-center -translate-x-20 rotate-45 bg-[#FAC872] transition-all duration-300 group-hover:h-64 group-hover:-translate-y-32"></span>
