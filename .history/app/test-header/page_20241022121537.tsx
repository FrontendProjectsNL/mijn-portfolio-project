    ...
    <div className="mt-10 ml-40">
      ...
      >
        ...
        <div className="h-10 w-10 bg-transparent cursor-pointer">
          ...
          {/* Bottom line */}
          <span className="absolute  h-[var(--thickness)] w-[var(--width)] -translate-x-1/2 translate-y-[calc(50%+var(--gap))] transition-transform duration-[calc(var(--duration)*2/3)]   w-[60%]  bg-red-500 rounded-full  group-aria-expanded:-translate-y-1/2 group-aria-expanded:-rotate-45  z-30 "></span>
        </div>
      </button>
    </div>
  );
