    ...
    <div className="">
      ...
      >
        ...
        <div className="flex gap-3">
          <Button
            size="lg"
            className="relative overflow-hidden font-medium text-black border-2 border-black px-12 rounded-full bg-transparent hover:bg-[#f27d4b] hover:bg-opacity-70"
          >
            <span className="absolute inset-0 bg-gradient-to-t from-[#f27d4b] to-transparent opacity-0 hover:opacity-70 transition-opacity duration-1000"></span>
