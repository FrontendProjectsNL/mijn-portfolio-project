...
import logo from '/public/EhsanLogo2.png';
...
const Header = () => {
  ...
  return (
    <nav
      className={` z-50 px-14 fixed transition-all duration-300 ease-linear bg-[#FAC872] flex justify-between items-center ${
        isShrunk
          ? 'h-[75px] w-[70%] rounded-3xl mx-auto top-5'
          : 'h-[90px] w-[1500px] opacity-100 top-7'
      }`}
      style={{
        left: '50%',
